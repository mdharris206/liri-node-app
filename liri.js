...
const concertFind = function() {axios.get("https://rest.bandsintown.com/artists/" + searchTerm + "/events?app_id=codingbootcamp").then(
  function(response) {
    ...
    for(let i=0; i < concertData.length; i++){
        ...
        const dateFormat = moment(concertData[i].datetime).format("MM DD YYYY");
...
const movieFind = function() {axios.get(" http://www.omdbapi.com/?t="+searchTerm+"8&apikey=7d60fd12").then(
    function(response){
